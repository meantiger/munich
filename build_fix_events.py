...
itinerary_data = [
  ...
  },
  {
    "day": 4,
    "dayLabel": "23일 (4일차)",
    "title": "23일: ⚽ 11:45 아레나 투어 & 뮤지엄 ➔ 슈바빙 카페 ➔ 낮의 영국정원 ➔ 레지덴츠 & 슈퍼 쇼핑 ➔ 켐핀스키 디너!",
    "summary": "10:30 알리안츠 아레나 도착 후 비스트로 브런치, 11:45 스타디움 가이드 투어(1시간) & FCB 뮤지엄(1시간), 슈바빙 테라스 카페, 낮의 영국정원 서핑, 레지덴츠 궁전, 귀국 기념품 슈퍼 장보기, 그리고 5성급 켐핀스키 슈바르츠라이터 파인다이닝 완결 축배",
    "color": "#10b981",
